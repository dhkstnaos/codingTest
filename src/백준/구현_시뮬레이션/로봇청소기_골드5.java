...
d가 0인 경우에는 북쪽을, 1인 경우에는 동쪽을, 2인 경우에는 남쪽을, 3인 경우에는 서쪽
        ...
        3. 아직 청소하지 않았다면 전진 후 1번 진행
        4. 네 방향 모두 청소가 되어 있거나 벽인 경우 바라보는 방향을 유지한 채로 한 칸 후진 후 2번으로 돌아간다.
        5. 네 방향 모두 청소가 되어 있거나 벽이고, 뒤쪽 방향도 벽일 때 작동을 멈춘다.
*/
public class 로봇청소기_골드5 {
